...
\namiKK{In such cases, you should use \KKverb|\KKvScanOff| which deactivates the sccaning process used internally in \KKverb|KKverb.lua|.} Of course, \KKverb|\KKvScanOn| re-activetes the process.

\subsection{Optional Useage}
In addition to the main function of \KKverb|\KKverb|, some optional funcions are provided.

\KKverb|\KKvOpChange| can change font and color of the output of \KKverb|\KKverb|. Also, it can activate or deactivate the sccaner.
